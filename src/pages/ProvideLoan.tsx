...
import { provideloans } from './BlockchainServices';
...
function ProvideLoan() {
    const [user, setUser] = useState<User>({
      ...
      const sumbitform = async() =>{
        ...
        const res = provideloans({aadhaarnumber,loanamount})
        console.log(res)
      }    
    ...
    <div>
        ...
        <div className="flex-1 flex flex-col justify-center px-4 pt-10 sm:px-4   lg:flex-none lg:px-20 xl:px-24">
          <div className="mx-auto w-full  bg-white px-10 py-5 rounded-xl max-w-sm lg:w-96">
            <div>
              <h2 className="mt-5 text-3xl font-extrabol text-green-700">Provide Loan</h2>
